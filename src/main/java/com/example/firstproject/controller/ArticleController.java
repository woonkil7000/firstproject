...
public class ArticleController {
    ...
    public String createArticle(ArticleForm form, RedirectAttributes rttr){
        ...
        //DTO객체(ArticleForm)에 title, content를 담아서 사용

        //System.out.println(form.toString());
        // sysout => log.info()로 대체.
        ...
        //Repository에게 엔티티를 DB에 저장하게함.
        // Article클래스에서 article 객체(ID 자동생성,title,content)를 DB에 전달

        Article saved = articleRepository.save(article);

        //System.out.println(saved.toString());
        log.info("saved.toString() => "+saved.toString());
        log.info("Article saved 객체에 id 값이 생성된 것을 볼 수 있다!! ");
